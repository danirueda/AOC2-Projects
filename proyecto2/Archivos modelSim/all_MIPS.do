...
add wave -noupdate -expand -group UC_DMA -label next_state /testbench/uut/MD_IO/Controlador_DMA/UC/next_state
add wave -noupdate -expand -group UC_DMA -label DMA_Burst /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_Burst
add wave -noupdate -expand -group UC_DMA -label DMA_IO_RE /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_IO_RE
add wave -noupdate -expand -group UC_DMA -label DMA_IO_WE /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_IO_WE
add wave -noupdate -expand -group UC_DMA -label DMA_MD_RE /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_MD_RE
add wave -noupdate -expand -group UC_DMA -label DMA_MD_WE /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_MD_WE
add wave -noupdate -expand -group UC_DMA -label DMA_send_addr /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_send_addr
add wave -noupdate -expand -group UC_DMA -label DMA_send_data /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_send_data
add wave -noupdate -expand -group UC_DMA -color {Orange Red} -label DMA_sync /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_sync
add wave -noupdate -expand -group UC_DMA -color {Orange Red} -label IO_sync /testbench/uut/MD_IO/Controlador_DMA/UC/IO_sync
add wave -noupdate -expand -group UC_DMA -label DMA_wait /testbench/uut/MD_IO/Controlador_DMA/UC/DMA_wait
add wave -noupdate -expand -group UC_DMA -label count_enable /testbench/uut/MD_IO/Controlador_DMA/UC/count_enable
