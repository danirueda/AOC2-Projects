...
add wave -noupdate -group {Banco IF/ID} -label IR_in /testbench/uut/Banco_IF_ID/IR_in
add wave -noupdate -group {Banco IF/ID} -label IR_ID /testbench/uut/Banco_IF_ID/IR_ID
...
add wave -noupdate -color Magenta -label Bus_data /testbench/uut/MD_IO/Controlador_DMA/Bus_data
add wave -noupdate -color {Medium Orchid} -label Bus_addr /testbench/uut/MD_IO/Controlador_DMA/Bus_addr
...
add wave -noupdate -group MD_cont -label MD_addr /testbench/uut/MD_IO/controlador_MD/MD_addr
add wave -noupdate -group MD_cont -label MD_Dout /testbench/uut/MD_IO/controlador_MD/MD_Dout
...
add wave -noupdate -group DMA/reg_data -label Din /testbench/uut/MD_IO/Controlador_DMA/reg_data/Din
...
add wave -noupdate -group IO -label Din /testbench/uut/MD_IO/IO/Din
